...
public class VirtualPetSimulator {
    public static void main(String[] args) {
        ...
        myPets[1].play();
        myPets[2].sleep();
        myPets[1].setName("What.");
        myPets[0].checkIfHappy();
        System.out.println(myPets[1].getStatus());
        System.out.println("The length of "+myPets[1].getName()+"'s name is: "+myPets[1].getName().length());
        ...
        System.out.println("The maximum energy of pets: "+Math.max(Math.max(myPets[0].getEnergy(), myPets[1].getEnergy()),myPets[2].getEnergy()));
