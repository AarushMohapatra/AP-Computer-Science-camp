...
public class FunMoneyManager {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.print("What percentage of your money do you want to save? Please enter a whole number.");
        ...
        System.out.println("Gifts for Others: $"+snacks+" ("+percentGifts+"%)");
        System.out.println("Other expenses: $"+snacks+" ("+percentExpenses+"%)");
        System.out.println("Total spending: $"+snacks+" ("+percentTotalSpending+"%)\n");
